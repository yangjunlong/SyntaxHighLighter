 ...
 * sql syntax hight
 * 
 * @author  Yang,junlong at 2015-11-21 11:30:09 build.
 * @version $Id$
 */

class Sql extends SyntaxHighLighter{
	...
	public function __construct () {
		...
		$this->regexList = array(
			...
			array(
				'regex' => $this->genRegex($keywords, 'mi'),
				'css' => 'keyword'
			),
			array(
				'regex' => $this->genRegex($funcs, 'mi'),
				'css' => 'keyword'
			),
			array(
				'regex' => $this->genRegex($operators, 'mi'),
				'css' => 'keyword'
			),
		);
	}
